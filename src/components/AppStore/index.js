...
class AppStore extends Component {
  ...
  getImages = () => {
    ...
    const filterImages = appsList.filter(each => each.category === activeId)
  ...
  render() {
    ...
    const filterImages = this.getImages()
    ...
    return (
      <div className="app-container">
        ...
        <ul className="list-images-container">
          {filterImages.map(eachImg => (
            <AppItem imageDetails={eachImg} key={eachImg.appId} />
          ))}
        </ul>
      </div>
    )
